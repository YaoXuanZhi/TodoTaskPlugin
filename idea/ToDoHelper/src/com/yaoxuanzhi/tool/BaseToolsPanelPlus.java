...
public abstract class BaseToolsPanelPlus<T extends Tool> extends JPanel {
  enum Direction {
    UP {
      @Override
  ...
  protected BaseToolsPanelPlus() {
    ...
    add(ToolbarDecorator.createDecorator(myTree).setAddAction(new AnActionButtonRunnable() {
      ...
      public void run(AnActionButton button) {
        ToolEditorDialogPlus dlg = createToolEditorDialog(ToolsBundle.message("tools.add.title"));
        Tool tool = new Tool();
...
//        tool.setShownInProjectViews(true);
      ...
      public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (originalTool != null) {
          ToolEditorDialogPlus dlg = createToolEditorDialog(ToolsBundle.message("tools.copy.title"));
  ...
  private void editSelected() {
    ...
    if (node != null && node.getUserObject() instanceof Tool) {
      ...
      if (selected != null) {
        ...
        ToolEditorDialogPlus dlg = createToolEditorDialog(ToolsBundle.message("tools.edit.title"));
  ...
  protected ToolEditorDialogPlus createToolEditorDialog(String title) {
    return new ToolEditorDialogPlus(this, title);
  }
