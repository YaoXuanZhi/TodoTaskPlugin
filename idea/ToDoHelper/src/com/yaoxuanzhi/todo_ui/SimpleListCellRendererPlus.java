 ...
 * @author gregsh
 */
public abstract class SimpleListCellRendererPlus<T> extends JBLabel implements ListCellRenderer<T> {

  @NotNull
  public static <T> SimpleListCellRendererPlus<T> create(@NotNull String nullValue, @NotNull Function<? super T, String> getText) {
    return new SimpleListCellRendererPlus<T>() {
      @Override
  ...
  @NotNull
  public static <T> SimpleListCellRendererPlus<T> create(@NotNull Customizer<? super T> customizer) {
    return new SimpleListCellRendererPlus<T>() {
      @Override
      public void customize(@NotNull JList<? extends T> list, T value, int index, boolean selected, boolean hasFocus) {
