...
class FilterDialogPlus extends DialogWrapper {
   ...
   */
  FilterDialogPlus(Component parent, TodoFilter filter, int filterIndex, List<? extends TodoFilter> filters, List<TodoPattern> patterns) {
    super(parent, true);
